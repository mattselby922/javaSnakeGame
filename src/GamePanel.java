...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void newApple() { // Generates apple coordinates
    ...
    public void move() {
        ...
        // For loop moves bodyparts
        for (int i = bodyParts; i > 0; i--) {
            x[i] = x[i - 1];
            y[i] = y[i - 1];
        }

        // Switch case for setting direction
        switch (direction) {
            case 'U':
                y[0] = y[0] - UNIT_SIZE;
                break;
    ...
    public void checkCollisions() {
        ...
        // Iterate through snake bodyparts, checks if head collides w/ body
        for (int i = bodyParts; i > 0; i--) {
            if ((x[0] == x[i]) && (y[0] == y[i])) {
